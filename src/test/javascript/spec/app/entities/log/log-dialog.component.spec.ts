...
import { LogDialogComponent } from '../../../../../../main/webapp/app/entities/log/log-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Log Management Dialog Component', () => {
        let comp: LogDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(LogDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'logListModification', content: 'OK'});

...
import { AlarmDialogComponent } from '../../../../../../main/webapp/app/entities/alarm/alarm-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Alarm Management Dialog Component', () => {
        let comp: AlarmDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(AlarmDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'alarmListModification', content: 'OK'});
